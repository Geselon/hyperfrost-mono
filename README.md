...
The code block is rendered using Figma. It looks way better inside an actual code editor like VS Code.
...
- **Emboldened Punctuations:** Thickened `"`, `'`, `` ` ``, `.`, `:`, and `;` for better visibility.
